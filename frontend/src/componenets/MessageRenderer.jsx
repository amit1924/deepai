...
//     <div
//       ref={contentRef}
//       className="message-renderer relative  rounded-2xl shadow-2xl  p-4 mb-6 animate-fade-in
...
//             prose-p:text-gray-300 prose-p:leading-7 prose-p:mb-3 prose-p:text-base
//             sm:prose-p:leading-8 sm:prose-p:mb-4
...
//             prose-blockquote:border-l-4 prose-blockquote:border-blue-500 prose-blockquote:bg-gray-800/50 prose-blockquote:pl-4 prose-blockquote:py-2
//             prose-ul:list-disc prose-ul:pl-4 prose-li:marker:text-orange-400
//             prose-ol:list-decimal prose-ol:pl-4 prose-ol:marker:text-indigo-400

//             prose-table:w-full prose-table:max-w-full prose-table:overflow-x-auto
//             prose-th:bg-gray-800 prose-th:text-blue-300 prose-th:font-bold prose-th:px-3 prose-th:py-2
...
//               components={{
//                 table: ({ children }) => (
//                   <div className="responsive-table rounded-lg my-3">
//                     <table className="w-full min-w-full border-collapse">
//                       {children}
//                     </table>
//                   </div>
