...
//                 onKeyDown={handleInputKeyDown}
//                 rows={1}
//                 className="w-full max-w-[700px] p-2 sm:p-3 bg-transparent placeholder-gray-400 text-white resize-none focus:outline-none min-h-[26px] sm:min-h-[34px] max-h-16 sm:max-h-24"
//                 style={{
//                   height: '26px',
//                   overflowY: 'auto',
//                   WebkitOverflowScrolling: 'touch',
